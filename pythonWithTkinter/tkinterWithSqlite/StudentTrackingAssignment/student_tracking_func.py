...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_students (col_fname,col_lname,col_fullname,col_phone,col_email,col_course) VALUES (?,?,?,?,?,?)""", ('Tim','Berners-Lee','Tim Berners-Lee','123-456-7890','tbl@yahoo.com','Intro to Computer Science'))
            conn.commit()
    conn.close()
